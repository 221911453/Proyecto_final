                ...
                <div class="row">
                    ...
                    <center>
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            ...
                            <div class="row g-0">
                              <div class="col-md-4">
                                <img src="{{asset('assets/img/user.jpg')}}" class="img-fluid rounded-start" alt="..."  width="150">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body">
                                  <h5 class="card-title">{{$user->nombre }} {{$user->app }} {{$user->apm }}</h5>
                                  <p class="card-text">{{$user->direccion}}</p>
                                  <p class="card-text">{{$user->telefono1}}</p>
                                  <p class="card-text">{{$user->telefono2}}</p>
                                  <p class="card-text">{{$user->tipousuario}}</p>
                                  <p class="card-text">{{$user->email}}</p>
                                  <p class="card-text">{{$user->pass}}</p>
