		...
		<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
			<div class="container-fluid">
				<div class="inner-sec-shop px-lg-4 px-3">
					<h3 class="tittle-w3layouts my-lg-4 mt-3">Productos </h3>
					<div class="row">
						<!-- product left -->
						<div class="side-bar col-lg-3">
							<div class="search-hotel">
								<h3 class="agileits-sear-head">Encuentra lo que deceas..</h3>
								<form action="{{route('datos')}}" method="get">
										<input class="form-control" type="text" name="texto" placeholder="Buscar aquí.." value="">
							...
							<div class="wrapper_top_shop">
								<div class="row">
										<div class="col-md-6 shop_left">
												<img src="images/cruz.jpeg" alt="">

											</div>
											<div class="col-md-6 shop_right">
												<img src="images/lavadero.jpeg" alt="">
												...
												<div class="men-thumb-item">
													...
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="{{ route('detallepro', ['id'=>$item->id])}}" class="link-product-add-cart">Ver </a>
														</div>
													</div>
