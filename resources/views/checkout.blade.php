	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container">
			<div class="inner-sec-shop px-lg-4 px-3">
				...
				<h3 class="tittle-w3layouts my-lg-4 mt-3">Mis productos </h3>
				<div class="checkout-right">
					...
					<form action="{{'guardarpedido'}}" method="post"role="form" enctype="multipart/form-data">
					...
					<table class="timetable_sub">
						...
						<tbody>
							...
							<tr>
								...
								<input type="integer" name="id_producto" value="{{$item['id']}}" hidden><td >{{$item['id']}}</td>
									...
									<div class="quantity">
										<div class="quantity-select">
											<div class="entry value">
												<input type="integer" name="cantidad" value="{{$item['quantity']}}" hidden><span>{{$item['quantity']}}</span>
											</div>
									</div>
								</td>
								<td class="invert">$ {{$item['price']}}</td>
								<td class="invert"><input type="text" name="total" value="{{$item['price'] * $item['quantity']}}" hidden>$ {{$item['price'] * $item['quantity']}}</td>

                                <td> <form action="{{route('cart.removeitem')}}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$item->id}}">
                                    <button type="submit" class="btn btn-link btn-sm text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square-fill" viewBox="0 0 16 16">
						...
						<div class="col-lg-2 my-3" >
							<form action="{{ route('cart.clear') }}" method="POST">
								{{ csrf_field() }}
								<button class="btn btn-danger">Vaciar Carrito<i class="fa fa-trash"></i></button>
							</form>
						</div>
					...
					<center>
						<div class="col-md-4 checkout-left-basket">
							<div class="checkout-left-basket">
								<h4><button class="navbar-toggler" type="submit">Realizar pago</button></h4>
							</div>
							</div>
					</center>
