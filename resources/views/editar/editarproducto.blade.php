...
<body>
    ...
    <div class="container-form sign-up">
        ...
        <form class="formulario" id="form" action="{{ route('salvar2',['id' => $produc->id]) }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <br>
            ...
            <input type="text" name="foto2" value="{{ $produc->foto }}" class="form-control" hidden >
            ...
            <br><br>
            <button type="submit" class="formulario__btn" value="Registrar">Salvar</button>
