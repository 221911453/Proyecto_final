...
const expresiones = {
	...
	direccion: /^[a-zA-ZÀ-ÿ\s]{4,50}$/, // Letras y espacios, pueden llevar acentos.
	telefono1: /^\d{10,14}$/, // 7 a 14 numeros.
	telefono2: /^\d{10,14}$/, // 7 a 14 numeros.
...
form.addEventListener('submit', (e) => {
	...
	if(campos.nombre && campos.app  && campos.apm && campos.direccion && campos.telefono1 && campos.telefono2 && campos.correo  && campos.password){
		form.reset();
